...
@section('conteudo')
    ...
    <div class="col-md-3 text-center">
        <br>
        <a href=""><img onmouseover="bigImg(this)" onmouseout="normalImg(this)" class="imgs"
                ...
                alt="" width="90%"></a>
        <h5>Spirit</h5>
        <p>Um Cavalo 1/2 argentino de 7 anos, contem uma pelagem marrom escuro e é do sexo masculino.</p>
        <p>Entre em contato com o dono pelo numero: 932423423 </p>
    </div>
    <div class="col-md-3 text-center">
        <br>
        <a href=""><img onmouseover="bigImg(this)" onmouseout="normalImg(this)" class="imgs"
                ...
                alt="" width="90%"></a>
        <h5>{nome_animal}</h5>
        <p>Um Cavalo {raça_animal} de {idade_animal} anos, contem uma pelagem {cor_animal} e é do sexo {sexo_animal}</p>
        <p>Entre em contato com o dono pelo numero: {tel} </p>
    </div>
    <div class="col-md-3 text-center">
        <br>
        <a href=""><img onmouseover="bigImg(this)" onmouseout="normalImg(this)" class="imgs"
    ...
    <nav class="paginas" id="pages" >
        <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link" href="notas">2</a></li>
