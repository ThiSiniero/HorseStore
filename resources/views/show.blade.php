...
@section('conteudo')
        ...
        <div class="col-4 text-center"><br>
            <a href="/HorseStore-comprador/editar/{{ $cavalo->id }}"><button type="submit" for='forms' class="btn btn btn-success">Editar</button></a>
            <a href="/HorseStore-comprador/excluir/{{ $cavalo->id }}"><button type="submit" for='forms' class="btn btn btn-danger">Excluir</button></a>
        </div>     
